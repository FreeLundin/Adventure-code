...
bool FConnectorClient::Connect(const FString& URL, const FString& InProtocol)
{
	...
	// Bind delegates
	WebSocket->OnConnected().AddRaw(this, &FConnectorClient::OnConnected);
	WebSocket->OnConnectionError().AddRaw(this, &FConnectorClient::OnConnectionError);
	WebSocket->OnClosed().AddRaw(this, &FConnectorClient::OnClosed);
	WebSocket->OnMessage().AddRaw(this, &FConnectorClient::OnMessage);
	WebSocket->OnRawMessage().AddRaw(this, &FConnectorClient::OnRawMessage);
